...
vec3 dither(vec2 screenUv, vec3 color) {
  vec2 scaledCoord = floor(screenUv * resolution / pixelSize);
...
function DitheredWaves({
  ...
  return (
    <mesh ref={mesh} scale={[viewport.width, viewport.height, 1]} onPointerMove={handlePointerMove}>
      ...
      <shaderMaterial vertexShader={waveVertexShader} fragmentShader={waveFragmentShader} uniforms={uniformsRef.current} />
    </mesh>
  )
}
